...
Namespace Allowance_Tracker.Tests
    ...
    <TestFixture>
    Public Class AllowanceNotEarnedTest

        <Test>
        Public Sub AddNonAllowanceReasonsChildView()
            ...
            Dim buttonCheckObj As Button = windowKidMain.Get(Of Button)("btnCheckAllowanceBalance")
            buttonCheckObj.Click()

            Dim windowAllowance As Window = app.GetWindow("View Allowance", InitializeOption.NoCache)

            Assert.IsNotNull(windowAllowance)
